...
{
  #load Stopwords
  c = readLines("C:\\Users\\HP\\Desktop\\R\\Project\\stopwords.txt")
  cs=unlist(strsplit(c,","))
  stopwords= stopwords('eng')
  head(stopwords)
  '#removed cup and holiday as it shows for all types of sentiment'
  c= c(cs,stopwords,c("hortons","tim","shit","cup","holiday","amp","cups","christmas","people","gay","latte","drink","drinks","conservatives","agenda"))
...
saveRDS (dataTHortons,file="C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\\starbucks1127.Rda")

####LOAD POSITIVE AND NEGATIVE KEYWORDS
pos <-scan("C:\\Users\\HP\\Desktop\\R\\Project\\positiveWords.txt",what='character',comment.char=";" )
neg <-scan("C:\\Users\\HP\\Desktop\\R\\Project\\negativeWords.txt",what='character',comment.char=";" )
...
#Next Read All Files
df <-readRDS("C:\\Users\\HP\\Desktop\\R\\Project\\starbucks1127.Rda")
#df <-readRDS("C:\\Users\\HP\\Desktop\\R\\Project\\starbucksTMP1126_200.Rda")

#access tweets and create cumulative file
  #searchterm="c:\\data\\starbucksTMP1125"
  searchterm = "C:\\Users\\HP\\Desktop\\R\\Project\\starbucks1127"
