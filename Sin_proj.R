...
sk <-"0M9NThScHHmsob0exvG3mlE3h"
ssk <- "B9t5vKGUnb0AYG0wMS7uElVHSqxwVEgcFDFFAxrn0ciNceda8x" 

#### FUNCTIONS
getStopWords <- function()
{
  #load Stopwords
  c = readLines("C:\Users\HP\Desktop\R\Project\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\stopwords.txt")
...
Access_Token_Secret  <-"ZtZzSr6wgmsA6KqyDuXMrGH1qgT5b4uUX1jqs8soeSBP7"
Owner   <- "kogutc"
Owner_ID  <- "47718023"
...
str(dataTHortons)
twTH
saveRDS (dataTHortons,file="C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\\starbucksTMP2000.Rda")

####LOAD POSITIVE AND NEGATIVE KEYWORDS
pos <-scan("C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\\positiveWords.txt",what='character',comment.char=";" )
neg <-scan("C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\\negativeWords.txt",what='character',comment.char=";" )
...
#Next Read All Files
df <-readRDS("C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\\starbucksTMP2000.Rda")
#access tweets and create cumulative file
  searchterm="C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\\starbucksTMP2000"
  ...
  #SAVE DATA FOR WEKA
  write.csv(s.dff, file=paste('C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master', '_WEKA.csv'), row.names=TRUE) #save evaluation results into the file
  saveRDS("C:\\Users\\HP\\Desktop\\R\\Project\\CAPSTONE---Twitter-Sentiment-Analysis-Naive-master\\dataforWEKA.RDS",s.df)
  ...
  #TESTING MODELS
  # test the validity
  predicted = predict(classifier, mat[11:15, 2]); predicted
